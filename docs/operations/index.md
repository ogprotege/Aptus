...
That matrix combines current v5/v3 small-model QLoRA acceptance at exact source
`719255153e3fc7e38e83b5ff826d587e5e58bf80`, the original Phase 6 baseline,
historical v2/v2 evidence, and
proposed larger-model and LoRA target-host work. The current result is scoped to
the exact accepted artifact, source tree, bundle fingerprint, and recorded
environment; it does not close CUDA or another artifact's required runtime
gates or establish safety, quality, performance, production readiness, or
release readiness. Read the linked immutable evidence record before treating a
row as passed.
