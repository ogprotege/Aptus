...
**Lane 3** is a later separate increment (not M10, not a 0.2 ship): operator-attested run disposition after a completed train. Spec: [`docs/superpowers/specs/2026-08-18-lane-3-run-disposition-design.md`](../superpowers/specs/2026-08-18-lane-3-run-disposition-design.md). Plan: [`docs/superpowers/plans/2026-08-18-lane-3-run-disposition.md`](../superpowers/plans/2026-08-18-lane-3-run-disposition.md).
