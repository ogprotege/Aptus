...
class DocumentationTests(unittest.TestCase):
    ...
    def test_phase4_public_documentation_is_synchronized(self) -> None:
        ...
        self.assertEqual(len(repository_documents), 147)
        self.assertEqual(len(excluded_documents), 1)
        self.assertEqual(len(governed_documents), 146)
        self.assertEqual(len(active_documents), 117)
        ...
        self.assertEqual(len(maintained_documentation()), 146)
        self.assertIn("146 are governed", normalized_inventory)
        self.assertIn("146 governed", normalized_inventory)
        self.assertIn("147 tracked Markdown", normalized_inventory)
        self.assertIn("| Active | 117 |", inventory)
