...
class DocumentationTests(unittest.TestCase):
    ...
    def test_phase4_public_documentation_is_synchronized(self) -> None:
        ...
        self.assertEqual(len(repository_documents), 146)
        self.assertEqual(len(excluded_documents), 1)
        self.assertEqual(len(governed_documents), 145)
        self.assertEqual(len(active_documents), 116)
        ...
        self.assertEqual(len(maintained_documentation()), 145)
        self.assertIn("145 are governed", normalized_inventory)
        self.assertIn("145 governed", normalized_inventory)
        self.assertIn("146 tracked Markdown", normalized_inventory)
        self.assertIn("| Active | 116 |", inventory)
