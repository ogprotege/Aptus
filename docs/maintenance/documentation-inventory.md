...
The repository tree contains 149 tracked Markdown documents. Of those, 148 are
...
|---|---:|---|
| Active | 119 | Current guidance, governance, navigation, evidence, protocol, or current research with explicit limits |
...
| Total | 148 | Excludes only the pull-request workflow template from tracked Markdown governance |
...
The automated `maintained_documentation()` set contains the 148 governed
Markdown files. Together with the root `LICENSE`, that makes 149 maintained
reader documents.
