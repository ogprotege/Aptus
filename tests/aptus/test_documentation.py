...
class DocumentationTests(unittest.TestCase):
    ...
    def test_phase4_public_documentation_is_synchronized(self) -> None:
        ...
        self.assertEqual(len(repository_documents), 144)
        self.assertEqual(len(excluded_documents), 1)
        self.assertEqual(len(governed_documents), 143)
        self.assertEqual(len(active_documents), 114)
        ...
        self.assertEqual(len(maintained_documentation()), 143)
        self.assertIn("143 are governed", normalized_inventory)
        self.assertIn("143 governed", normalized_inventory)
        self.assertIn("144 tracked Markdown", normalized_inventory)
        self.assertIn("| Active | 114 |", inventory)
